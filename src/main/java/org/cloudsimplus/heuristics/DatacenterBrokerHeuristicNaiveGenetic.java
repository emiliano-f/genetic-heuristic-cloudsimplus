 ...
 */
public class DatacenterBrokerHeuristicNaiveGenetic {
    ...
    private CloudletToVmMappingNaiveGenetic heuristic;
     ...
     */
    private DatacenterBrokerHeuristicNaiveGenetic() {
